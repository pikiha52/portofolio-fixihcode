<template>
<div class="bg-yellow-500 rounded shadow-lg md:py-20 md:px-40">
    ...
    <div class="bg-white shadow-lg rounded py-2 px-2 md:py-32 md:px-20">
        ...
        <div class="hidden md:grid md:grid-cols-2 md:gap-0 w-full">
            ...
            <div class="md:bg-white md:shadow-lg md:rounded-xl md:w-full md:px-8 md:py-4">
                ...
                <p class="font-extrabold font-poppins text-yellow-500 text-sm mb-2">Full Stack Developer</p>
                <p class="font-semibold font-poppins text-gray-600 text-sm">Hello, my name Fikih Alan people used to call me Pikih or Kih, I'am a Full Stack Developer, i can use Framework Laravel, Codeigniter, Flutter, Tailwindcss. I really like the new thing about programming. For more information, visit <a href="https://github.com/pikiha52" class="text-yellow-500">pikiha52.github.io</a></p>
            </div>
            <!-- {{-- end --}} -->
        </div>
        ...
        <div class="grid grid-rows-none gap-4 py-4 md:grid md:grid-cols-2 md:gap-10 md:py-8">
            <div class="bg-white shadow-lg rounded-xl w-full px-8 py-4">
                <p class="font-bold font-poppins text-sm text-yellow-500 mb-4">Project Experince</p>
                <ul class="list-disc">
                    <li>
                        <p class="font-poppins font-normal text-gray-600 text-xs">Website Recruitment</p>
                    </li>
                    <li>
                        <p class="font-poppins font-normal text-gray-600 text-xs">Website Daily Activity</p>
                    </li>
                    <li>
                        <p class="font-poppins font-normal text-gray-600 text-xs">Website Anti Fake Products</p>
                    </li>
                    <li>
                    ...
                    <li>
                        <p class="font-poppins font-normal text-gray-600 text-xs">Website E-commerce</p>
                    </li>
                </ul>
            </div>

            <div class="bg-white shadow-lg rounded-xl w-full px-8 py-4">
                <p class="font-poppins text-sm font-bold text-yellow-500 mb-4">Job Experience</p>
                <ul class="list-disc">
                    <li>
        ...
        <div class="md:grid md:grid-cols-2 md:gap-10 mb-4">
            <div class="bg-white rounded-xl shadow-lg mb-4 px-8 py-4">
                <p class="font-poppins text-yellow-500 font-bold text-sm mb-4">Programming Skils</p>
            ...
            <div class="bg-white rounded-xl shadow-lg px-8 py-4">
                <p class="text-sm font-bold font-poppins text-yellow-500 mb-4">Favorites</p>
                <div class="flex justify-between px-4 mb-4">
                    <div class="items-start">
                        <div class="bg-white rounded-md px-5 py-5 shadow-lg flex flex-col space-y-2 items-center text-yellow-500">
